...
const mapCurrentEvents = (obj) => {
  // Solution code here...
  let array = currentEvents.news.map(e => { 
    return new Event(e);
  })
  return array;
}
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let reducedArray = arr.reduce((accumulator, currentValue, currentIndex, array) => {
    return currentValue;
  }, 0);
...
const returnNames = (arr) => {
  // Solution code here...
  let nameArray = [];
  arr.reduce((accumulator, currentValue, currentIndex, starWarsData) => {
    nameArray.push(currentValue.name);
  }, 0);
  return nameArray;
};
...
const reversedString = (str) => {
  ...
  const reversedString = strArr.reduce((reversed, character) => {
...
const countNumberOfChildren = (arr) => {
  ...
  let children = arr.reduce((accumulator, currentValue) => {
    console.log(currentValue.children, 'CHILDREN')
